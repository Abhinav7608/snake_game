...
pygame.draw.line(window,(255,255,255),(5,0),(5,460))

def showlines():
    for i in range(20, 460, 20):
        pygame.draw.line(window, (255,255,255), (i, 0), (i, 460))
    for i in range(20, 460, 20):
        pygame.draw.line(window, (255,255,255), (0, i), (460, i))
showlines()
...
def drawsnake():
    ...
    for i in range(0,len(snakedots)):
        ...
        pygame.draw.rect(window,(255,165,0),snake)
drawsnake()
...
while True:
    ...
    if snakedots[0]["x"] == fruitx and snakedots[0]["y"] == fruity:
        ...
        del snakedots[-1]
    movesnake()
    if snakedots[0]["x"] < 0 and snakedots[0]["x"] > 23 or snakedots[0]["y"]<0 or snakedots[0]["y"]>23:
        break
